...
class ListViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    // MARK: Properties
    private lazy var viewModel = ListViewModel(viewController: self)
    ...
    @objc private func searchButtonTapped() {
        ...
        viewModel.fetchMovies(containing: searchQuery)
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let movieViewController = MovieDetailsViewController(viewModel: viewModel)
        viewModel.viewController = movieViewController
