...
/// ზუსტად ვერ მივხვდი array-ს აკვადრატება რას ნიშნავს
...
// ფუნქციამ უნდა მიიღოს String-ი, და დააბრუნოს dictionary,
// სიტყვებით და იმ რაოდენობით რამდენჯერ იყო ერთი და იგივე სიტყვა გამოყენებული String-ში.
// uppercase და lowercase ასოები უნდა იყოს დაჰენდლილი ერთნაირად,
// მაგალითად თუ function-s გადავაწვდით "TBC x USAID, tbc it academy, we are in TBC academy."
// function-მა უნდა დააბრუნოს
// ["tbc": 3, "academy": 2, "we": 1, "are": 1, "in": 1, "it": 1, "x": 1]
func makeWordFrequencies(_ str: String) -> [String: Int] {
    let a = str
...
makeWordFrequencies("TBC x USAID, tbc it academy, we are in TBC academy.")
...
func filterOddNumbers(_ nums: [Int]) -> [Int] {
